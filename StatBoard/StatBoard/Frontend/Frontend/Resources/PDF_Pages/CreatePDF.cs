...
//    public PdfDocument CreatePDF5(Guid idMatch)
//    {
//        if (!LoadData(idMatch))
//        {
...
//        string canchaWithMarksPath = crearImagenMarcada(absolutePathCancha, marcasCampo, new SKColor(255, 0, 0)); // Rojo fuerte
...
//        if (end == Ending.Goal || end == Ending.Miss || end == Ending.Save)
//        {
//            arcoWithMarksPath = crearImagenMarcada(absolutePathArco, marcasArco, new SKColor(0, 0, 255)); // Azul fuerte
//        }
...
//        // Generar imágenes con marcas
//        string absolutePathCancha = "C:\\Users\\Pc\\Desktop\\App\\StatBoard\\StatBoard\\Frontend\\Frontend\\Resources\\Images\\cancha.png";
//        string canchaWithMarksPath = crearImagenMarcada(absolutePathCancha, marcasCampo, new SKColor(255, 0, 0)); // Rojo semitransparente
...
//        if (end == Ending.Goal || end == Ending.Miss || end == Ending.Save)
//        {
//            string absolutePathArco = Path.Combine(FileSystem.AppDataDirectory, "arco.png");
...
//            };
//            var imageOutputPath = Path.Combine(FileSystem.AppDataDirectory, "arco_marcado.png");
//            crearImagenMarcada(absolutePathArco, marcasArco, greenTranslucentPaint, imageOutputPath); // Azul semitransparente
//            string nombreArch = "arco_marcado.png";
//            var arcoWithMarksPath = XImage.FromFile(nombreArch);
//            var markedArcoImage = XGraphics.FromPdfPage(pdfPage);
//            markedArcoImage.DrawImage(arcoWithMarksPath, 0, 0, 150, 200);
//        }
//    }
